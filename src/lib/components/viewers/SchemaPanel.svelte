...
{#if visible}
	<div
		class="w-64 shrink-0 overflow-auto border-l border-zinc-200 bg-zinc-50 dark:border-zinc-800 dark:bg-zinc-900"
	>
		...
		<div class="divide-y divide-zinc-100 dark:divide-zinc-800">
			{#each fields as field}
				...
				<div class="px-3 py-1.5">
					...
					<span class="ml-7 text-[10px] text-zinc-400 dark:text-zinc-500">
						{field.type}
					</span>
				</div>
			{/each}
